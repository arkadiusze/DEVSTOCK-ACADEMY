...
2. Wtyczka Live Server służy do automatycznego odświeżania otwartej strony.
3. Wtyczka Prettier uporządkowuje kod przy zapisywaniu.
...
5. Spowodowało to zmianę w tytule karty otwartej w przeglądarce.
